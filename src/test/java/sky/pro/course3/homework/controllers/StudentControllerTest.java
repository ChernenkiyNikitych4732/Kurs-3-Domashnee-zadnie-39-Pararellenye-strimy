package sky.pro.course3.homework.controllers;
...
import sky.pro.course3.homework.repository.AvatarRepository;
import sky.pro.course3.homework.repository.StudentRepository;
import sky.pro.course3.homework.service.AvatarService;
...
public class StudentControllerTest {
    ...
    @Test
    public void ageCollect() throws Exception {
        JSONObject studentObject = new JSONObject();
        studentObject.put("name", name);
        studentObject.put("age", age);
        ...
        when(studentRepository.findAllByAge(eq(age))).thenReturn(students);
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/student/collect/3")
                        .content(studentObject.toString())
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(result -> List.of(student));
    }
